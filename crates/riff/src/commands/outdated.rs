...
pub struct OutdatedArgs {
    ...
    #[usage(complete = crate::commands::completion::complete_outdated_package)]
    ...
    /// Sort packages by the age of their installed release
    #[usage(long)]
...
pub async fn execute(args: OutdatedArgs, context: &CommandContext) -> Result<i32> {
