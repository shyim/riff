...
//!
//! ```ignore
//! use riff_core::solver::{Pool, Request, Solver, Policy};
//!
//! let pool = Pool::new();
...
//!     Ok(transaction) => crate::outln!("Solution found!"),
//!     Err(problems) => crate::outln!("No solution: {:?}", problems),
//! }
//!
...
pub use policy::{package_matches_platform_requirements, recommended_require_constraint, Policy};
...
pub use rule_set::{RuleSet, RuleSetKind};
